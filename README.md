<img width="1400" height="849" alt="image" src="https://github.com/user-attachments/assets/8ec5ac1d-99ab-40e7-89e1-7622a94745e5" /># noshRadio

**多音源聚合桌面音乐播放器** — 在一个统一界面中搜索、播放和发现来自多个音源的音乐。

基于 Tauri（Rust）构建。内置 AI 品味系统、Bilibili 视频集成和插件支持。
<img width="1403" height="851" alt="image" src="https://github.com/user-attachments/assets/5762cc6a-f360-4e2c-aa32-6b8905c90b48" />
